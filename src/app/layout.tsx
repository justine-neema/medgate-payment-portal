            ...
            <div className="bg-gradient-to-r from-[#F7F9FC] to-white border-t border-gray-100">
              <div className="container mx-auto px-4">
                <div className="flex flex-wrap items-center justify-center md:justify-start py-3 gap-4 md:gap-6">
                  ...
                  <div className="flex items-center">
                    <svg
                      className="w-4 h-4 text-[#2E86AB] mr-2"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
                  ...
                  <div className="flex items-center">
                    <svg
                      className="w-4 h-4 text-[#FF6B35] mr-2"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-gray-400 mb-6 max-w-md">
                    Providing world-class healthcare services with cutting-edge technology and
                    compassionate care since 2005.
                  </p>
                ...
                <div>
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      <svg
                        className="w-5 h-5 text-[#FF6B35] mr-3 mt-0.5"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                      ...
                      <span className="text-gray-400">
                        1-800-MED-GATE
                        <br />
                        <span className="text-sm">(633-4283)</span>
                      </span>
                    </li>
                    <li className="flex items-start">
                      <svg
                        className="w-5 h-5 text-[#2E86AB] mr-3 mt-0.5"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                  ...
                  <div className="flex items-center space-x-6">
                    <div className="text-xs text-gray-500 flex flex-wrap justify-center gap-4">
                      <span className="flex items-center">
                        <svg
                          className="w-4 h-4 mr-1 text-[#2E86AB]"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
