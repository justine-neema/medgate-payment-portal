    ...
    <>
      <div className="w-full bg-[#FBFBFB] h-[70px] md:h-[85px] lg:h-[95px] px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 flex items-center relative z-50">
        <div className="flex flex-row justify-between w-full items-center">
          ...
          <Button className="hidden lg:inline-flex bg-[#F85814] hover:bg-[#F85814]/90 text-white font-semibold text-base pr-[30px] pl-[30px] pt-[25px] pb-[25px] rounded-full transition-all duration-300 hover:scale-105 min-w-[160px]">
            Get Started
          </Button>
